...
let text = "Cám ơn em đã dành thời gian để xem những trò trẻ con mà a đã làm ra.Cám ơn em vì đã đến bên anh,đã thêm từng sự ngọt ngào vào cuộc sống của anh.Anh mong rằng chúng ta sẽ luôn có nhau và bên nhau cho dù là vui hay buồn.Một lần nữa a cám ơn em vì đã đến.Anh Yêu Em"
